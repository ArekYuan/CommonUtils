...
import cn.yaohl.commonutils.sharepref.SharePref;
import cn.yaohl.commonutils.ui.BaseActivity;
...
public class utilApplication extends Application {
     ...
     * app 实例
     */
    private static utilApplication PDM_APPLICATION = null;

    public static Context applicationContext;


    public synchronized static utilApplication getInstance() {
        if (null == PDM_APPLICATION) {
            PDM_APPLICATION = new utilApplication();
        }
