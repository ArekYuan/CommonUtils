...
import cn.yaohl.commonutils.ui.home.HomeFragment;
import cn.yaohl.commonutils.ui.personal.PersonalFragment;
import cn.yaohl.commonutils.ui.service.ServiceFragment;
import cn.yaohl.commonutils.utilApplication;
            ...
            if (keyCode == KeyEvent.KEYCODE_BACK) {
                if (!isBack) {
                    ...
                    if (event.getDownTime() - downTime <= 2000) {
                        utilApplication.getApplication().exit();
                    } else {
