...
public class StretchingScrollview extends ScrollView
{
    ...
    public StretchingScrollview(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }
...
//      }
    ...
    {
        public void onHeaderRefresh(StretchingScrollview view);
    }
