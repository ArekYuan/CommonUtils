package cn.yaohl.MayorOnline.ui.lmessage.adapter;
...
public class MessageListAdapter extends
    ...
    private List<MessageListResp> mData = new ArrayList<>();
    ...
    public void setmData(List<MessageListResp> mData) {
        this.mData.clear();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        MessageListResp resp = mData.get(position);
