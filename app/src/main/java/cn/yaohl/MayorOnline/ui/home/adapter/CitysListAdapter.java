...
public class CitysListAdapter extends BaseAdapter {
    ...
    private List<CityBeans.ProvincesBean.CitysBean> mData = new ArrayList<>();
    private Context mContext;
    private LayoutInflater mInflater;

    public CitysListAdapter(Context mContext) {
        this.mContext = mContext;
        mInflater = LayoutInflater.from(mContext);
    }

    public void setmData(List<CityBeans.ProvincesBean.CitysBean> mData) {
        this.mData.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.cityNameTxt.setText(mData.get(position).getCitysName());
        return convertView;
    }
