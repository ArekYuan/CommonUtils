...
//                    if (e.getY() == this.yValues3 || e.getY() == this.yValues2 || e.getY() == this.yValues1)//折线图 只显示 指定的markerView
    ...
    public void setValuesY(float yValues1, float yValues2, float yValues3) {
        this.yValues1 = yValues1;
        this.yValues2 = yValues2;
        this.yValues3 = yValues3;
    }
